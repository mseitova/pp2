...
image = pygame.image.load('images/mickey.png').convert_alpha()
left = pygame.image.load('images/left-hand.png').convert_alpha()
right = pygame.image.load('images/right-hand.png').convert_alpha()
